// (1) Replaces don't, can't, etc. with do not, cannot, etc. respectively
// (2) Replaces punctuation with spaces if
//   (i) it's not within double quotes, OR
//   (ii) it's a hyphen within words
